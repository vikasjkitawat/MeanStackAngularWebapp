...
let EshopComponent = class EshopComponent {
    ...
    addProduct(newProduct) {
        ...
        promise.then((updatedProductList) => //success
         {
...
let ProductentryComponent = class ProductentryComponent {
    constructor(_dataService, _routerService) {
...
ProductentryComponent.ctorParameters = () => [
...
let ProductlistComponent = class ProductlistComponent {
    constructor(_dataService, _changeDetector) {
        this._dataService = _dataService;
...
let EShopModule = class EShopModule {
};
